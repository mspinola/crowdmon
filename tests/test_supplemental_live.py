...
def test_c6_the_plausible_band_is_narrower_than_c3_swept(vintage_panel):
    """`2026-08-03 §C6`. Pins the correction to §C3's own headline.

    §C3 swept `w_SD` over {0.2, 0.4, 0.7} and quoted a 42.0% swing in median `A`. 0.7 is
