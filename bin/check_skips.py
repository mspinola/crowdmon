...
**Why this exists.** 67 of this package's assertions live in `tests/*_live.py` and need the
...
CI runs against a two-panel fixture, so those 67 have never run in CI and a green badge has
