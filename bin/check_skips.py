...
**Why this exists.** 52 of this package's assertions live in `tests/*_live.py` and need the
...
runs against a two-panel fixture, so those 52 have never run in CI and a green badge has
