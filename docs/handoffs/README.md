...
| [2026-08-02-trend-alignment.md](2026-08-02-trend-alignment.md) | **claimed, not started.** Spec §368. Both inputs already exist: `trigger.py` computes the 20/60/250 TSMOM. Measured first: the blend is +-1/3 for 69% of markets because their horizons disagree, and the score has **no warm-up**, so it is the earliest-starting engine in the package and the second that can reach 2008 |
