...
| [2026-08-02-correlation-clustering.md](2026-08-02-correlation-clustering.md) | **claimed, not started.** Spec §369. Measured first: sector taxonomy is mostly right (0.410 within against 0.077 across), and §369's own JPY-energy example is **not in the data** (-0.14). The real cross-class cluster is the yen with the US rates complex, 0.46 to 0.54 |
