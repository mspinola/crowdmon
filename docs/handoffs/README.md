...
| [2026-08-02-coverage-reporting.md](2026-08-02-coverage-reporting.md) | **complete (PR #15).** `futures/coverage.py`, keyed on `market_code`. Both decisions recorded in the outcome. The handoff's premise held and one detail did not: `058643` drops at `extremity_z`, not at the price join |
