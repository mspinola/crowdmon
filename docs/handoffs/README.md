...
| [2026-08-02-macro-book-pca.md](2026-08-02-macro-book-pca.md) | **claimed, not started.** §7's macro-book PCA on positioning changes, PC1 share as the futures absorption ratio. Measured: 24 markets buys the full 947-week span, and the panel reaches **2008**, which `D` structurally cannot |
