...
| [2026-08-02-macro-book-pca.md](2026-08-02-macro-book-pca.md) | **complete (PR #20).** `futures/macro_pca.py`. PC1 is the grain complex on Disaggregated and the macro book on TFF (`B21`), so the report type is the subject rather than a parameter. Reaches 2008; no episode examined, deliberately |
