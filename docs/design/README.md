...
| [`amendments-2026-08-05.md`](amendments-2026-08-05.md) | **here** | E1-E3: six live pins failing on store drift (the universe grew from 47 covered markets to 49, and every failure is a count), the worktree suite figures being wrong in both halves, and `column_definitions` publishing the four panel columns the consumer could only admit it had no words for. **The open file** |
