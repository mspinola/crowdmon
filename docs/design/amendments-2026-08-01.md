...
| A.7 | ~~trigger solver, volatility trigger, forced flow~~ | **built 2026-08-01.** `A` was never needed, see [2026-08-02 §B8](amendments-2026-08-02.md) |
...
| A.8 | reflexivity amplification `1/(1 - ℓg)` | ~~A.5 and A.7~~ **nothing structural.** Needs `ℓ` and `g`, both estimable from the built pieces |
